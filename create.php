            ...
            <body>
              ...
              <form action="proses-pendaftaran.php" method="POST">
                <fieldset>
                  ...
                  <input class="box1" type="text" name="username" id="username" placeholder="Enter your Username" required="required"><br>
                  <label for="password">Password</label><br>
                  <input class="box1" type="password" name="password" id="pass" placeholder="Enter your Password" required="required"><br>
                  ...
                  <div class="form-group">
						        <input type="submit" class="form-control btn btn-primary" value="Daftar" name="daftar">
					        </div>
					        <div class="form-group">
